    ...
    <div style={{ minHeight: "100vh", background: "#080d18" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <a href="https://app.dynafy.nl/register" className="btn-cta" style={{ padding: "9px 18px", fontSize: 14 }}>
            {t.ctaNav}
          </a>
        </div>
      </nav>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 780, position: "relative", zIndex: 1 }}>
          ...
          <div className="anim-4" style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", marginBottom: 48 }}>
            <a href="https://app.dynafy.nl/register" className="btn-cta">
              {t.heroCta1} <Arrow />
            </a>
      ...
      <section id="zzp" style={{ padding: "100px 40px", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "center" }}>
          ...
          <div>
            ...
            <a href="https://app.dynafy.nl/register" className="btn-cta" style={{ background: "linear-gradient(135deg, #a855f7, #6366f1)", boxShadow: "0 4px 24px rgba(168,85,247,0.35)" }}>
              {t.zzpCta} <Arrow />
            </a>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20 }}>
            {PLANS.map(plan => (
              <div key={plan.name} style={{
                ...
                <a href="https://app.dynafy.nl/register" style={{
      ...
      <section style={{ padding: "100px 40px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 600, margin: "0 auto", position: "relative" }}>
          ...
          <a href="https://app.dynafy.nl/register" className="btn-cta" style={{ fontSize: 17, padding: "17px 36px" }}>
            {t.finalCta} <Arrow />
          </a>
